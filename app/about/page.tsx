...
import { COMMON_BREADCRUMBS } from "@/constants/breadcrumbs"
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div>
              ...
              <p className="text-neutral-700 leading-relaxed mb-4">
                ...
                beginning, the company adopted the policy of producing high-quality packing machines at competitive
                packing machine prices in Pakistan and providing exceptional small packing machines, automatic packing
                machines, and shrink packaging machines in Lahore.
              </p>
              <p className="text-neutral-700 leading-relaxed mb-4">
                For clients specifically searching for <strong>packaging machine Lahore</strong> solutions, our team
                based in Lahore ensures rapid support, local installation, and after-sales service.
              </p>
              <p className="text-neutral-700 leading-relaxed mb-4">
                Our reputation as a leading packing machine manufacturer in Pakistan is built on our commitment to
                excellence and prompt after-sales service, which has helped us establish a strong and growing client
                base. Buy packing machines from us at the best packing machine price in Pakistan.
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div>
              ...
              <p className="text-neutral-700 leading-relaxed mb-4">
                ...
                chocolates, candies, bakery items, ice lollies, soap and detergent bars. Our automatic packing machines,
                vacuum packaging machines, and airtight packaging machines offer competitive packing machine prices in
                Pakistan.
              </p>
              <p className="text-neutral-700 leading-relaxed mb-4">
                ...
                Arabia, Sri-Lanka, Nigeria, Mozambique and U.A.E. They buy packing machines from us due to our
                reputation as a reliable machine manufacturer.
              </p>
      ...
      <section className="relative py-16 text-white overflow-hidden">
        ...
        <div className="relative max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center rounded-xl bg-white px-6 py-3 text-sm font-medium transition focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 hover:bg-gray-100 min-h-[44px]"
              style={{ color: "#c8a415" }}
            >
              Contact Us
            </Link>
            <Link
              href="/products"
              className="inline-flex items-center justify-center rounded-xl border-2 border-white px-6 py-3 text-sm font-medium text-white transition focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 hover:bg-white hover:text-gray-800 min-h-[44px]"
            >
              Explore Products
            </Link>
          </div>
